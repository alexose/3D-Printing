    ...
    module tab() {
        ...
        difference(){
            ...
            union() {
                ...
                translate([-1, 3.27, 4.5]) cube(w, center=true);
                // Kind of a cheesy way of doing this, but oh well
                translate([-r+1, 0, c-0.8]) scale([1, 0.75, 1]) cube(c, center=true);
                
                // translate([-1, 3.27, 4.5]) rotate([115, 0, -70]) cylinder(r+1, r=w);
                // translate([-1, -3.27, 4.5]) rotate([115, 0, -110]) cylinder(r+1, r=w);
            }
        }
    }
