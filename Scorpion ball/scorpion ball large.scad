...
// rotate([180, 0]) translate([-r - t, 0, -r - th/2]) top_half_outer();
// rotate([180, 0]) translate([-r - t, r*2, -r - th/2]) top_half_inner();
// rotate([180, 0]) translate([r, 0, -r - th/2]) bottom_half();
// translate([0, r * 2, 0]) inner_gasket(); 
// translate([0, -r * 2, 0]) outer_gasket();
translate([-r, 0]) wrench();
